...
const SupportTierCard: React.FC<ISupportTierProps> = (props) => {
    ...
    React.useEffect(() => {
        console.log("all supporters: " + supporters);
    }, [supporters]);
                ...
                >
                    ...
                    <DialogContent >
                        {supporters.map((supporter) => {
                            return (
                                <Card key={supporter.supporterId} sx={{ display: "flex", alignItems: "center", justifyContent: "start", padding: "5px", margin: "5px" }}>
                                    <CardHeader
